...
namespace CodeGeneration.DocFX.Overwrite
{
    internal class SpecificationModifier
    {
        ...
        [CanBeNull]
        public static Overwrite LoadOverwrites(string overwriteFile)
        {
            ...
            var deserializer = new DeserializerBuilder()
                ...
                .Build();
            return deserializer.Deserialize<Overwrite>(TextTasks.ReadAllText(overwriteFile));
        }

        public static void OverwriteFromFile(Tool tool, string overwriteFilePath)
        {
            var overwrite = LoadOverwrites(overwriteFilePath);
